...
def do_sample(model: str, model_type: str, dataset: List[str], iter: int):
    ...
    for device in range(device_count):
        sample_cmd = (f'{conda_prefix} USE_OPENCOMPASS_EVALUATOR=True MUSA_VISIBLE_DEVICES={device} swift sample '
    ...
    for device in range(device_count):
        sample_cmd = (
            f'{conda_prefix} USE_OPENCOMPASS_EVALUATOR=True MUSA_VISIBLE_DEVICES={device} swift sample '
