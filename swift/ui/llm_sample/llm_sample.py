...
class LLMSample(BaseUI):
    ...
    locale_dict = {
        ...
        'gpu_id': {
            ...
            'info': {
                'zh': '选择采样使用的GPU号，如MUSA不可用只能选择CPU',
    ...
    def sample(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{musa_param}start /b swift sample {params} > {log_file} 2>&1'
        else:
            run_command = f'{musa_param} nohup swift sample {params} > {log_file} 2>&1 &'
