        ...
        if sys.platform == 'win32':
            ...
            if envs:
                ...
                for env in envs:
                    _envs += f'set {env} && '
                envs = _envs
            run_command = f'{musa_param}{ddp_param}{envs}start /b swift sft {params} > {log_file} 2>&1'
        else:
            run_command = f'{musa_param} {ddp_param} {envs} nohup swift {cmd} {params} > {log_file} 2>&1 &'
